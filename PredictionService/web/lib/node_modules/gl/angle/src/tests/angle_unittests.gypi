...

{
    'variables':
    {
        ...
        [
            '<(angle_path)/src/org.thepanday.informatikproject.common/BitSetIterator_unittest.cpp',
            '<(angle_path)/src/org.thepanday.informatikproject.common/Optional_unittest.cpp',
            '<(angle_path)/src/org.thepanday.informatikproject.common/mathutil_unittest.cpp',
            '<(angle_path)/src/org.thepanday.informatikproject.common/matrix_utils_unittest.cpp',
            '<(angle_path)/src/org.thepanday.informatikproject.common/string_utils_unittest.cpp',
            '<(angle_path)/src/org.thepanday.informatikproject.common/utilities_unittest.cpp',
