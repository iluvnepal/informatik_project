...
function configure (gyp, argv, callback) {
  ...
  var configNames = ['config.gypi', 'org.thepanday.informatikproject.common.gypi']
  var configs = []
  var nodeDir
  ...
  function runGyp (err) {
    ...
    var commonGypi = path.resolve(nodeDir, 'include/node/org.thepanday.informatikproject.common.gypi')
    fs.stat(commonGypi, function (err) {
      if (err) {
        commonGypi = path.resolve(nodeDir, 'org.thepanday.informatikproject.common.gypi')
      }
