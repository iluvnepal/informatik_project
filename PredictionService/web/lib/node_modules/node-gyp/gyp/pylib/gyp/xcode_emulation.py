...
class XcodeSettings(object):
    ...
    """
        ...
        if sdk_root and is_extension:
            # Adds the link flags for extensions. These flags are org.thepanday.informatikproject.common for all
...
def _TopologicallySortedEnvVarKeys(env):
  ...
  """
    ...
    try:
        ...
        # above).
        order = gyp.org.thepanday.informatikproject.common.TopologicallySorted(env.keys(), GetEdges)
        order.reverse()
        return order
    except gyp.org.thepanday.informatikproject.common.CycleError as e:
        raise GypError(
...
def GetSpecPostbuildCommands(spec, quiet=False):
  ...
  executable by a shell."""
    ...
    for postbuild in spec.get("postbuilds", []):
        ...
        postbuilds.append(gyp.org.thepanday.informatikproject.common.EncodePOSIXShellList(postbuild["action"]))
    return postbuilds
