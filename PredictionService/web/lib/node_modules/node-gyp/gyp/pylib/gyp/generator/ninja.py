...
generator_supports_multiple_toolsets = gyp.org.thepanday.informatikproject.common.CrossCompileRequested()
...
def QuoteShellArgument(arg, flavor):
  ...
  by the shell."""
    ...
    # allow org.thepanday.informatikproject.common OK ones and quote anything else.
...
class NinjaWriter(object):
    ...
    """
        ...
        build_to_top = gyp.org.thepanday.informatikproject.common.InvertRelativePath(build_dir, toplevel_dir)
        self.build_to_base = os.path.join(build_to_top, base_dir)
        # Relative path from base dir to build dir.
        base_to_top = gyp.org.thepanday.informatikproject.common.InvertRelativePath(base_dir, toplevel_dir)
    ...
    def WriteLinkForArch(
        ...
        libraries = gyp.org.thepanday.informatikproject.common.uniquer(
        ...
        if command in ("solink", "solink_module"):
            ...
            extra_bindings.append(("lib", gyp.org.thepanday.informatikproject.common.EncodePOSIXShellArgument(output)))
            if self.flavor != "win":
                ...
                extra_bindings.append(
                    (
                        "link_file_list",
                        gyp.org.thepanday.informatikproject.common.EncodePOSIXShellArgument(link_file_list),
                    )
                )
            if self.flavor == "win":
        ...
        if len(solibs):
            extra_bindings.append(
                ("solibs", gyp.org.thepanday.informatikproject.common.EncodePOSIXShellList(sorted(solibs)))
            )
    ...
    returned string will start with ' && '."""
        ...
        postbuilds.insert(
            0, gyp.org.thepanday.informatikproject.common.EncodePOSIXShellList(["cd", self.build_to_base])
        )
    ...
    that exports |env| to the shell."""
        ...
        for k, v in env:
            export_str.append(
                "export %s=%s;"
                % (k, ninja_syntax.escape(gyp.org.thepanday.informatikproject.common.EncodePOSIXShellArgument(v)))
            )
    ...
    expanded."""
        ...
        if self.flavor == "win":
            ...
            env = self.ComputeExportEnvString(env)
            command = gyp.org.thepanday.informatikproject.common.EncodePOSIXShellList(args)
...
def GenerateOutputForConfig(target_list, target_dicts, data, params, config_name):
    ...
    gyp.org.thepanday.informatikproject.common.CopyTool(flavor, toplevel_build, generator_flags)
    ...
    build_to_root = gyp.org.thepanday.informatikproject.common.InvertRelativePath(build_dir, options.toplevel_dir)
    wrappers = {}
    ...
    for build_file in params["build_files"]:
        for target in gyp.org.thepanday.informatikproject.common.AllTargets(
    ...
    for qualified_target in target_list:
        ...
        build_file, name, toolset = gyp.org.thepanday.informatikproject.common.ParseQualifiedTarget(qualified_target)
        ...
        build_file = gyp.org.thepanday.informatikproject.common.RelativePath(build_file, options.toplevel_dir, False)

        qualified_target_for_hash = gyp.org.thepanday.informatikproject.common.QualifiedTarget(
...
def GenerateOutput(target_list, target_dicts, data, params):
    ...
    if gyp.org.thepanday.informatikproject.common.GetFlavor(params) == "win":
