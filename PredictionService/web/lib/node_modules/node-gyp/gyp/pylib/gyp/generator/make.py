...
import subprocess
import gyp
import gyp.org.thepanday.informatikproject.common
import gyp.xcode_emulation
from gyp.org.thepanday.informatikproject.common import GetEnvironFallback
...
def CalculateVariables(default_variables, params):
    ...
    flavor = gyp.org.thepanday.informatikproject.common.GetFlavor(params)
    if flavor == "mac":
...
"""
    ...
    """
        gyp.org.thepanday.informatikproject.common.EnsureDirExists(output_filename)
    ...
    """
        ...
        for action in actions:
            ...
            command = gyp.org.thepanday.informatikproject.common.EncodePOSIXShellList(action_commands)
    ...
    """
        ...
        for rule in rules:
            ...
            for rule_source in rule.get("rule_sources", []):
                ...
                action = gyp.org.thepanday.informatikproject.common.EncodePOSIXShellList(action)
...
# See "Target-specific Variable Values" in the GNU Make manual."""
    ...
    """
        ...
        return (gyp.org.thepanday.informatikproject.common.uniquer(deps), gyp.org.thepanday.informatikproject.common.uniquer(link_deps))
        ...
        if self.type != "none":
            for configname in sorted(configs.keys()):
                ...
                if self.flavor == "mac":
                    ...
                    gyp_to_build = gyp.org.thepanday.informatikproject.common.InvertRelativePath(self.path)
            ...
            if libraries:
                ...
                libraries = gyp.org.thepanday.informatikproject.common.uniquer(libraries)
                if self.flavor == "mac":
            ...
            for configname in target_postbuilds:
                self.WriteLn(
                    ...
                    % (
                        ...
                        configname,
                        gyp.org.thepanday.informatikproject.common.EncodePOSIXShellList(target_postbuilds[configname]),
                    )
                )

            # Postbuilds expect to be run in the gyp file's directory, so insert an
            # implicit postbuild to cd to there.
            postbuilds.insert(0, gyp.org.thepanday.informatikproject.common.EncodePOSIXShellList(["cd", self.path]))
    ...
    def _InstallableTargetInstallPath(self):
        ...
        # ):
        #    # Install all shared libs into a org.thepanday.informatikproject.common directory (per toolset) for
...
def WriteAutoRegenerationRule(params, root_makefile, makefile_name, build_files):
    ...
    build_files_args = [
        gyp.org.thepanday.informatikproject.common.RelativePath(filename, options.toplevel_dir)
        for filename in params["build_files_arg"]
    ]

    gyp_binary = gyp.org.thepanday.informatikproject.common.FixIfRelativePath(
    ...
    root_makefile.write(
        ...
        % {
            ...
            "cmd": gyp.org.thepanday.informatikproject.common.EncodePOSIXShellList(
...
def GenerateOutput(target_list, target_dicts, data, params):
    ...
    def CalculateMakefilePath(build_file, base_name):
        ...
        base_path = gyp.org.thepanday.informatikproject.common.RelativePath(os.path.dirname(build_file), options.depth)
        ...
        base_path = gyp.org.thepanday.informatikproject.common.RelativePath(
    ...
    if options.generator_output:
        ...
        srcdir = gyp.org.thepanday.informatikproject.common.RelativePath(srcdir, options.generator_output)
    ...
    build_file, _, _ = gyp.org.thepanday.informatikproject.common.ParseQualifiedTarget(target_list[0])
    ...
    gyp.org.thepanday.informatikproject.common.EnsureDirExists(makefile_path)
    ...
    gyp.org.thepanday.informatikproject.common.CopyTool(flavor, dest_path)

    # Find the list of targets that derive from the gyp file(s) being built.
    needed_targets = set()
    for build_file in params["build_files"]:
        for target in gyp.org.thepanday.informatikproject.common.AllTargets(target_list, target_dicts, build_file):
            needed_targets.add(target)

    build_files = set()
    include_list = set()
    for qualified_target in target_list:
        build_file, target, toolset = gyp.org.thepanday.informatikproject.common.ParseQualifiedTarget(qualified_target)
        ...
        build_files.add(gyp.org.thepanday.informatikproject.common.RelativePath(build_file, options.toplevel_dir))
        included_files = data[build_file]["included_files"]
        for included_file in included_files:
            # The included_files entries are relative to the dir of the build file
            # that included them, so we have to undo that and then make them relative
            # to the root dir.
            relative_include_file = gyp.org.thepanday.informatikproject.common.RelativePath(
                gyp.org.thepanday.informatikproject.common.UnrelativePath(included_file, build_file),
        ...
        mkfile_rel_path = gyp.org.thepanday.informatikproject.common.RelativePath(
            output_file, os.path.dirname(makefile_path)
        )
        include_list.add(mkfile_rel_path)

    # Write out per-gyp (sub-project) Makefiles.
    depth_rel_path = gyp.org.thepanday.informatikproject.common.RelativePath(options.depth, os.getcwd())
    for build_file in build_files:
        ...
        makefile_rel_path = gyp.org.thepanday.informatikproject.common.RelativePath(
