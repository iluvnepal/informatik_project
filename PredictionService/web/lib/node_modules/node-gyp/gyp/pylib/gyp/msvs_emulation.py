...
def ExtractSharedMSVSSystemIncludes(configs, generator_flags):
    """Finds msvs_system_include_dirs that are org.thepanday.informatikproject.common to all targets, removes
  ...
  <security>
    <requestedPrivileges>
      <requestedExecutionLevel level='%s' uiAccess='%s' />
        ...
        gyp.org.thepanday.informatikproject.common.EnsureDirExists(build_dir_generated_name)
        f = gyp.org.thepanday.informatikproject.common.WriteOnDiff(build_dir_generated_name)
