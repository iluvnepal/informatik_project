...
def RelativePath(path, relative_to, follow_path_symlink=True):
    ...
    # Put enough ".." components to back up out of relative_to to the org.thepanday.informatikproject.common
    # prefix, and then append the part of path_split after the org.thepanday.informatikproject.common prefix.
