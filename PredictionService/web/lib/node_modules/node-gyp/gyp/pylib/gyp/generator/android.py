  ...
  """
    ...
    """
        for action in actions:
            ...
            command = gyp.org.thepanday.informatikproject.common.EncodePOSIXShellList(action["action"])
            ...
            for input in inputs:
                if not input.startswith("$(") and " " in input:
                    raise gyp.org.thepanday.informatikproject.common.GypError(
    ...
    """
        ...
        for rule in rules:
            ...
            for rule_source in rule.get("rule_sources", []):
                ...
                command = gyp.org.thepanday.informatikproject.common.EncodePOSIXShellList(components)
                cd_action = "cd $(gyp_local_path)/%s; " % self.path
                command = cd_action + command
                if dirs:
                    command = "mkdir -p %s" % " ".join(dirs) + "; " + command
    ...
    """
        ...
        origin_src_dirs = gyp.org.thepanday.informatikproject.common.uniquer(origin_src_dirs)
    ...
    """
        ...
        for path in include_paths:
            if path[0] == "/":
                path = gyp.org.thepanday.informatikproject.common.RelativePath(path, self.android_top_dir)
    ...
    """
        ...
        libraries = gyp.org.thepanday.informatikproject.common.uniquer(spec.get("libraries", []))
...
def GenerateOutput(target_list, target_dicts, data, params):
    ...
    for qualified_target in target_list:
        ...
        relative_build_file = gyp.org.thepanday.informatikproject.common.RelativePath(build_file, options.toplevel_dir)
        ...
        relative_target = gyp.org.thepanday.informatikproject.common.QualifiedTarget(
