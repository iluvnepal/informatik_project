...
class XcodeProject(object):
    def __init__(self, gyp_path, path, build_file_dict):
        ...
        projectDirPath = gyp.org.thepanday.informatikproject.common.RelativePath(
    ...
    def Finalize1(self, xcode_targets, serialize_all_tests):
        ...
        for target in self.build_file_dict["targets"]:
            ...
            qualified_target = gyp.org.thepanday.informatikproject.common.QualifiedTarget(
...
sys.exit(subprocess.call(sys.argv[1:]))" """
                ...
                script = (
                    ...
                    + "%s\nexit 1\n"
                    % gyp.xcodeproj_file.ConvertVariablesToShellSyntax(
                        gyp.org.thepanday.informatikproject.common.EncodePOSIXShellList(command.get("action"))
                    )
                )
...
def GenerateOutput(target_list, target_dicts, data, params):
    ...
    for qualified_target in target_list:
        [build_file, target_name, toolset] = gyp.org.thepanday.informatikproject.common.ParseQualifiedTarget(
            qualified_target
        )
        ...
        for action in spec_actions:
            ...
            if message:
                message = "echo note: " + gyp.org.thepanday.informatikproject.common.EncodePOSIXShellArgument(message)
            else:
                message = ""

            # Turn the list into a string that can be passed to a shell.
            action_string = gyp.org.thepanday.informatikproject.common.EncodePOSIXShellList(action["action"])
        ...
        for rule in spec_rules:
            ...
            for rule_source in rule.get("rule_sources", []):
                ...
                if message:
                    message = gyp.org.thepanday.informatikproject.common.EncodePOSIXShellArgument(message)
                    message = ExpandXcodeVariables(message, rule_input_dict)
                messages.append(message)

                # Turn the list into a string that can be passed to a shell.
                action_string = gyp.org.thepanday.informatikproject.common.EncodePOSIXShellList(rule["action"])
...
"""
        ...
        for postbuild in spec.get("postbuilds", []):
            action_string_sh = gyp.org.thepanday.informatikproject.common.EncodePOSIXShellList(postbuild["action"])
            script = "exec " + action_string_sh + "\nexit 1\n"
