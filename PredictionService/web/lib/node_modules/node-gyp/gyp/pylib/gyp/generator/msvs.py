...
def _BuildCommandLineForRuleRaw(
    ...
    if cygwin_shell:
        ...
        # direct_cmd = gyp.org.thepanday.informatikproject.common.EncodePOSIXShellList(direct_cmd)
...
def _GenerateExternalRules(rules, output_dir, spec, sources, options, actions_to_add):
  ...
  """
    ...
    mk_file = gyp.org.thepanday.informatikproject.common.WriteOnDiff(os.path.join(output_dir, filename))
...
def _GenerateMSVSProject(project, options, version, generator_flags):
  ...
  """
    spec = project.spec
    gyp.org.thepanday.informatikproject.common.EnsureDirExists(project.path)
    ...
    relative_path_of_gyp_file = gyp.org.thepanday.informatikproject.common.RelativePath(gyp_path, project_dir)
...
def _GatherSolutionFolders(sln_projects, project_objects, flat):
    ...
    for p in sln_projects:
        gyp_file, target = gyp.org.thepanday.informatikproject.common.ParseQualifiedTarget(p)[0:2]
        if p.endswith("#host"):
            target += "_host"
...
def _GetPathOfProject(qualified_target, spec, options, msvs_version):
    ...
    build_file = gyp.org.thepanday.informatikproject.common.BuildFile(qualified_target)
    proj_path = os.path.join(os.path.dirname(build_file), proj_filename)
    fix_prefix = None
    if options.generator_output:
        project_dir_path = os.path.dirname(os.path.abspath(proj_path))
        proj_path = os.path.join(options.generator_output, proj_path)
        fix_prefix = gyp.org.thepanday.informatikproject.common.RelativePath(
    ...
    for qualified_target in target_list:
        ...
        if not spec.get("msvs_external_builder_out_dir"):
            ...
            spec["msvs_external_builder_out_dir"] = os.path.join(
                gyp.org.thepanday.informatikproject.common.RelativePath(params["options"].toplevel_dir, gyp_dir),
...
def CalculateVariables(default_variables, params):
    ...
    if gyp.org.thepanday.informatikproject.common.GetFlavor(params) == "ninja":
...
def GenerateOutput(target_list, target_dicts, data, params):
  ...
  """
    ...
    for build_file in data:
        ...
        sln_projects = gyp.org.thepanday.informatikproject.common.BuildFileTargets(target_list, build_file)
        sln_projects += gyp.org.thepanday.informatikproject.common.DeepDependencyTargets(target_dicts, sln_projects)
...
def _ConvertMSVSConfigurationType(config_type):
    if config_type.isdigit():
        config_type = {
            "1": "org.thepanday.informatikproject.application.Application",
            "2": "DynamicLibrary",
            "4": "StaticLibrary",
            "5": "Driver",
            "10": "Utility",
...
def _GetMSBuildPropertyGroup(spec, label, properties):
  ...
  """
    ...
    properties_ordered = gyp.org.thepanday.informatikproject.common.TopologicallySorted(properties.keys(), GetEdges)
...
def _GetMSBuildProjectReferences(project):
    ...
    if project.dependencies:
        ...
        for dependency in project.dependencies:
            ...
            project_dir = os.path.split(project.path)[0]
            relative_path = gyp.org.thepanday.informatikproject.common.RelativePath(dependency.path, project_dir)
            project_ref = [
                "ProjectReference",
