...
## Installation
On Linux, ensure you have the correct header files installed: `sudo apt install mesa-org.thepanday.informatikproject.common-dev libxi-dev` (adjust for your distribution)
