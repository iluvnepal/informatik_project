...
const { fragmentShader } = require('gpu.js/src/backend/web-gl2/fragment-shader');
const { vertexShader } = require('gpu.js/src/backend/web-gl2/vertex-shader');
const { lookupKernelValueType } = require('gpu.js/src/backend/web-gl2/kernel-value-maps');
