...
const mrud = require('gpu.js/src/plugins/math-random-uniformly-distributed');
const { fragmentShader } = require('gpu.js/src/backend/web-gl/fragment-shader');
const { vertexShader } = require('gpu.js/src/backend/web-gl/vertex-shader');
const { glKernelString } = require('gpu.js/src/backend/gl/kernel-string');
const { lookupKernelValueType } = require('gpu.js/src/backend/web-gl/kernel-value-maps');
